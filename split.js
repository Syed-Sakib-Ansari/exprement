...
<body>
    ...
    <main class="max-w-4xl mx-auto px-4 pt-24 pb-16 flex flex-col items-center">
        ...
        <div class="w-full bg-yellow-500/10 border border-yellow-500/30 rounded-xl p-3 md:p-4 mb-4 flex items-start gap-3">
            ...
            <div>
                ...
                <p class="text-gray-300 text-xs mt-1 leading-relaxed">If you see a black screen or error, please tap the <strong>"Pop-ups blocked"</strong> notification at the top of your mobile browser and select <strong>"Always Show"</strong>.</p>
            </div>
        </div>
    ...
    <script>
        ...
        // 📺 🎯 FIXED: NO-RELOAD SPA ARCHITECTURE TO PREVENT BROWSER POP-UP LOCKDOWN
        function playEpisode(url, idx, btn, epDownloadUrl) {
            // ১. আমরা পুরো আইফ্রেম ধ্বংস না করে, জাস্ট ভেতরের সোর্স চেঞ্জ করব (SPA Method)
            const player = document.getElementById('videoPlayer');
            if (player) {
                // ২. কোনো পেজ রিলোড বা হিস্ট্রি চেঞ্জ ছাড়া ডাইরেক্ট সোর্স আপডেট
                player.src = url;
            }
            ...
            // ৩. ভিডিও প্লেয়ারের দিকে পেজ অটোমেটিক স্মুথ স্ক্রোল হবে
            window.scrollTo({ top: document.getElementById('playerContainer').offsetTop - 100, behavior: 'smooth' });
        }
...
function startStaticGeneration() {
    ...
    console.log(`\n✅ অল ডান সাকিব ভাই! SPA আর্কিটেকচারে ফাইল রি-জেনারেট সম্পূর্ণ হয়েছে।`);
}
